            ...
            >
              {producto.url_imagen ? (
                <Image
                  ...
                  style={{
                    filter: producto.stock_actual <= 0 ? "grayscale(100%)" : "none",
            ...
            {producto.stock_actual <= 0 && (
              <div style={{
                ...
                <p style={{
                  ...
                  ¡No te preocupes! Déjanos tu solicitud y te avisaremos inmediatamente cuando vuelva a estar disponible en nuestra colección.
                </p>
                <button
                    ...
                    try {
                      ...
                      if (res.success) {
                        toast.success("¡Suscripción activada! 💎", {
                          description: "Te enviaremos un aviso en cuanto tengamos stock disponible."
                        });
                      } else {
                        toast.error(res.error || "No se pudo activar la notificación");
                      }
                    } catch (err) {
