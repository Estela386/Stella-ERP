...
const ADDRESS =
  "C. Agustín de Iturbide 578, Santa Teresita, 44200 Guadalajara, Jal.";
const MAP_EMBED =
  "https://maps.google.com/maps?q=Agust%C3%ADn+de+Iturbide+578+Guadalajara+Jalisco&output=embed&z=16";
const GOOGLE_MAPS_LINK =
  "https://maps.google.com/?q=C.+Agustín+de+Iturbide+578,+Santa+Teresita,+44200+Guadalajara,+Jalisco";
      ...
      >
        <div className="mx-auto" style={{ maxWidth: 1100, padding: "0 24px" }}>
          ...
          >
            ...
            >
              Estamos aquí para{" "}
              <em style={{ fontStyle: "italic", color: "#b76e79" }}>
                ayudarte
              </em>
            </h1>
          </div>
          ...
          <div
            className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start animate-fade-up"
                ...
                <div style={{ display: "flex", gap: 16 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      ...
                      >
                        <span>Domingo</span>
                        <span style={{ fontWeight: 500, color: "#c0404f" }}>
                          Cerrado
                        </span>
                      </div>
                    </div>
              ...
              <div style={{ marginTop: 40 }}>
                <a
                  ...
                  onMouseEnter={e => {
                    ...
                    el.style.boxShadow =
                      "0 12px 24px rgba(183, 110, 121, 0.35)";
          ...
          <div
            ...
            style={{ marginTop: 80, animationDelay: "0.2s" }}
          >
