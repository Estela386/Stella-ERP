      ...
      <div className="flex-1 max-w-6xl mx-auto px-4 py-8 md:py-16">
        ...
        <div className="text-center mb-20 mt-10">
          ...
          <p className="text-[#708090] max-w-3xl mx-auto text-base md:text-lg leading-relaxed">
            Stella Joyería nació con la convicción de que cada pieza de joyería
            debe ser tan única como la persona que la porta. No somos solo una
            tienda, somos un equipo de artesanos y diseñadores apasionados por
            llevar la belleza, la elegancia y la exclusividad a tu vida
            cotidiana.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-[#708090] mb-3">
              Calidad Premium
            </h3>
            <p className="text-[#708090]/80 text-sm">
              Seleccionamos meticulosamente cada material. Nuestras gemas y
              metales pasan por estrictos controles para garantizar su brillo y
          ...
          >
            ...
            <p className="text-[#708090]/80 text-sm">
              Cada colección es limitada. Diseñamos pensando en la estética
              contemporánea sin perder el toque clásico que convierte a una joya
              en una reliquia.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-[#708090]/80 text-sm">
              Tu tranquilidad es nuestra prioridad. Ofrecemos pagos encriptados,
              envíos asegurados y una política de devolución transparente.
            </p>
          </div>
        </div>
        ...
        <div className="mt-24 mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-extrabold text-[#708090] mb-4">
              Lo que dicen{" "}
              <span className="text-[#b76e79]">Nuestros Clientes</span>
            </h2>
            <p className="text-[#708090]/80 max-w-2xl mx-auto text-sm md:text-base">
              Nos enorgullece recibir el cariño de las personas que confían en
              nosotros para sus momentos inolvidables.
            </p>
          </div>
        ...
        >
          <div>
            ...
            <p className="text-[#f6f4ef]/80 max-w-lg">
              Explora nuestro catálogo y encuentra esa pieza que hablará por ti
