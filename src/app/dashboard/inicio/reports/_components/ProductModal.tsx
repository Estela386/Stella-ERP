  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
      <div className="bg-white p-6 rounded-xl w-96 shadow-xl">
        {/* Nombre */}
        <label className="block text-[#708090] font-semibold mb-1">Nombre</label>
        <input
          type="text"
          value={form.nombre}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-[#708090] font-semibold mb-1">Total vendido</label>
            <input
              type="number"
              value={form.total ?? 0}
          ...
          <div>
            <label className="block text-[#708090] font-semibold mb-1">Precio</label>
            <input
              type="number"
              value={form.precio ?? 0}
          ...
          <div>
            <label className="block text-[#708090] font-semibold mb-1">Costo</label>
            <input
              type="number"
              value={form.costo ?? 0}
          ...
          <div>
            <label className="block text-[#708090] font-semibold mb-1">Stock actual</label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-[#708090] font-semibold mb-1">Stock mínimo</label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-[#708090] font-semibold mb-1">Categoría</label>
            <input
              type="text"
