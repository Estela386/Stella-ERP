...
export default function InventoryStats({
  ...
  const items = [
    { label: "Total", value: consignaciones.length, bgStart: "#758390", bgEnd: "#657582", icon: Package },
    { label: "Activas", value: activas, bgStart: "#C07E88", bgEnd: "#B76E79", icon: CheckCircle },
    { label: "Vencidas", value: vencidas, bgStart: "#758390", bgEnd: "#657582", icon: AlertCircle },
  ];
  ...
  return (
    ...
    }} className="stella-consignaciones-inventory-stats">
      <style>{`
        @media (max-width: 1024px) { 
          .stella-consignaciones-inventory-stats { grid-template-columns: repeat(2, 1fr) !important; gap: 16px !important; } 
        }
        @media (max-width: 600px)  { 
          .stella-consignaciones-inventory-stats { 
